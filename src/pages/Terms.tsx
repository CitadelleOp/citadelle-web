    ...
    <>
      ...
      <div style={{
        ...
        <div className="glass-panel" style={{ padding: '3rem', borderRadius: '24px' }}>
          ...
          <p style={{ marginBottom: '2rem' }}>
            <LogoText /> is a decentralized application (dApp) built on the Robinhood Chain. We do not hold your funds, take custody of your assets, or execute trades on your behalf. All transactions are peer-to-peer and governed entirely by smart contracts.
          </p>
