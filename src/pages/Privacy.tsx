    ...
    <>
      ...
      <div style={{
        ...
        <div className="glass-panel" style={{ padding: '3rem', borderRadius: '24px' }}>
          ...
          <p style={{ marginBottom: '2rem' }}>
            By using the <LogoText /> protocol, you understand that all transaction data—including your public wallet address and trading history—is permanently recorded on the Robinhood Chain, which is a public and immutable ledger. We have no control over this data.
          </p>
